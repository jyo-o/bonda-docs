# EDA-07: Single Multisig Controls All Eight Core Contracts Without Timelock
...
On-chain state was queried at block 25101686. See [Verification Evidence](../evidence.md#governance-multisig-configuration-eda-07) for full commands and results.
...
Affects the Decentralization baseline through governance concentration. An authorized multisig operating within its rights is the risk, so this is recorded as a Governance Observation and carries no score.
