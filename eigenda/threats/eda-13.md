# EDA-13: Proxy HTTP Server Missing Rate Limiting
...
Sets the Liveness Design Baseline. The absence of proxy-level rate limiting is a documented design property and carries no score.
