...
![Relay single point of failure — primary vs fallback retrieval path](https://raw.githubusercontent.com/jyo-o/bonda-docs/main/eigenda/assets/eda-d06-relay-spof.png)
...
On-chain state was queried at block 25101686. See [Verification Evidence](../evidence.md#relay-registry-single-point-of-failure-eda-d06) for full commands and results.
