# CEL-05: Low-cost Blockspace Monopoly via Large PFB Transactions
...
No exploit reproduction was conducted. This finding is based on source code analysis of the celestia-app and go-square codebases combined with on-chain gas parameter verification. See [Verification Evidence](../evidence.md#gas-and-blockspace-parameters-cel-05-cel-04) for gas price and cost calculations.
...
Affects the Cost Efficiency axis. It is tracked as an Operational Indicator shown alongside the risk pentagon, not as a deduction from the structural score.
