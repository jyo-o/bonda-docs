# CEL-09: SP1Blobstream Instant Upgrade via Unprotected 4-of-6 Multisig
...
On-chain verification was conducted. See [Verification Evidence](../evidence.md#sp1blobstream-bridge-verification-cel-09) for full commands and results.
...
Affects the Decentralization baseline; a small signer set can upgrade the bridge without delay. This is recorded as a Governance Observation and carries no score.
