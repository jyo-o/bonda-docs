...
No exploit reproduction was conducted. Evidence is based on on-chain staking data cross-verified across three independent endpoints as of 2026-05-24. See [Verification Evidence](../evidence.md#validator-set-and-slashing-parameters-cel-g01-cel-g02) for full parameter data.
