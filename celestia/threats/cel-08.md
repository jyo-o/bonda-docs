# CEL-08: KYC Validator Concentration Enabling Legal Censorship
...
No exploit reproduction was conducted. Evidence is based on on-chain staking data cross-verified across three independent endpoints as of 2026-05-24. See [Verification Evidence](../evidence.md#validator-set-and-slashing-parameters-cel-08-cel-10) for full parameter data.
...
Affects the Decentralization baseline through validator-set concentration. This is recorded as a Governance Observation and carries no score.
