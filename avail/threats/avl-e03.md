...
On-chain state was queried on Ethereum mainnet. See [Verification Evidence](../evidence.md#deployer-admin-role-verification-avl-e03) for full commands and results.
