# AVL-06: Deployer EOA Retains Admin Role Enabling Solo VectorX Upgrade
...
On-chain state was queried on Ethereum mainnet. See [Verification Evidence](../evidence.md#deployer-admin-role-verification-avl-06) for full commands and results.
...
Affects the Decentralization baseline; a deployer account retains admin authority over the bridge. This is recorded as a Governance Observation and carries no score.
