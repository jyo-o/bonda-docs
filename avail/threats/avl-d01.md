...
Anvil mainnet fork PoC and on-chain state verification were conducted. See [Verification Evidence](../evidence.md#vectorx-single-relayer-verification-avl-d01) for full commands and results.
